...
public class Solution0701 extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// link the values list to the list view through the adapter
	...
	public void onClick(View view) {
		...
		// since this is a ListActivity, pull in the activities list view
		...
		case R.id.add:
			...
			/*
			 **************************************************************
			 * TODO: Create random boolean value using:                   * 
			 * Random().nextBoolean()                                     *
			 * Add value to call "createComment"                          *
			...
			boolean nextApproval = new Random().nextBoolean();
			
			// add the randomly selected string to the database 
			// and return a new Comment type object
			comment = datasource.createComment(comments[nextInt],  nextApproval);
			
			// add the comment to our local adapter (and the list view)
			adapter.add(comment);
	...
	protected void onResume() {
		// open the data source when the activity is active
		datasource.open();
		super.onResume();
	}
	...
	protected void onPause() {
		...
		// close the data source when the activity is in the background
		datasource.close();
		super.onPause();
	}
